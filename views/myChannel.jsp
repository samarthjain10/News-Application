				...
				$scope.fav=function()
       		 	{
       		     	...
       		     	for(i=0 ; i<$scope.myChannelData.length;i++)
       		     	{
       		    	 	if($scope.myChannelData[i].select==true)
       		    	 	{
       		    		 	m=m+$scope.myChannelData[i].id+","; 	
       		    	 	}
       		     	}
				...
				<form>
	        		<div class="container_fluid">
			    		<div class="box" ng-repeat="x in myChannelData">
			        		...
			        		<p>{{x.description}}</p>
			        		<div class="checkbox">
			          			<label><input type="checkbox" ng-model="x.selected">Unsubscribe</label><br>
			          			<label><input type="checkbox" ng-model="x.select">Fav Channel</label>
			        		</div>
			    		</div>
			    		<br>
			    		<br>
			        	<center>
			        	<button type="button" class="btn btn-success" ng-click="unsubscribe()">unsubscribe</button>
			        	<button type="button" class="btn btn-success" ng-click="fav()">Fav Channel</button>
			        	</center>
			    	</div>
				</form>
			</div>
